...
public class TimeInstructorTest {
    ...
    public void equalsTest(){
        ...
        Time t3 = t;
        Assert.assertTrue(t.toString().equals(t2.toString()));
        Assert.assertTrue(t2.toString().equals(t.toString()));
        Assert.assertTrue(t.toString().equals(t3.toString()));
    ...
    public void compareToTest(){
        ...
        Collections.sort(list,new TimeAscendingOrder());
