...
public class CourseInstructorTest {
    ...
    private void endTimeTestHelper(String startTimeStr, String expectedEndTimeStr, int duration){
        ...
        Assert.assertTrue("End time should be " + expectedEndTimeStr + " when start time is " + startTimeStr +
                " and duration is " + duration, expectedEndTime.toString().equals(c.getEndTime().toString()));
    }
    ...
    public void cloneTest(){
        ...
        Assert.assertTrue(egr222.getStartTime() == startTime);
        Assert.assertTrue(egr222.getStartTime() == copy.getStartTime());
    }
    ...
    public void startTimeTest(){
        ...
        Assert.assertTrue(startTime.equals(egr222.getStartTime()));
        startTime.shift(90);
        Assert.assertTrue(Time.fromString("06:30 PM").toString().equals(startTime.toString()));
        Assert.assertTrue(startTime.equals(egr222.getStartTime()));
        Assert.assertFalse(Time.fromString("05:00 PM").equals(egr222.getStartTime()));
    }
    ...
    public void containsTest(){
        ...
        containsTestHelper(true, "10:00 AM", "MWF", 1, Weekday.FRIDAY, new Time(10, 1, true));
        containsTestHelper(true, "10:00 AM", "T", 120, Weekday.TUESDAY, new Time(11,59, false));
        containsTestHelper(false, "10:00 AM", "W", 120, Weekday.TUESDAY, new Time(12,0, true));
    }
